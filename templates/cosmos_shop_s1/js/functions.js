				...
				$lightboxAjaxEl.magnificPopup({
					...
					callbacks: {
						ajaxContentAdded: function(mfpResponse) {
							...
							if ($(this._lastFocusedEl).hasClass('add-to-cart') && isUseBasket == "1") {
								SEMICOLON.widget.hideFormProcess($(this._lastFocusedEl).parent().parent());
							}
						},
						open: function() {
							if ($(this._lastFocusedEl).hasClass('add-to-cart') && isUseBasket == "1") {
								...
								SEMICOLON.widget.showFormProcess($(this._lastFocusedEl).parent().parent());
							}
