...
$MESS["CT_BCE_CATALOG_ZAKAZ"] = "Заказать товар";
$MESS["CT_BCE_CATALOG_ASK"] = "Задать вопрос";
$MESS["CATALOG_ASK_FOR_PRICE"] = "По запросу";
$MESS["CAT_WATCH_ALL_SPEC"] = "Cмотреть все харрактеристики";
$MESS["MD_ND_FILE_SIZE"] = "Размер файла: ";
