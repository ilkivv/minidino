...
?>
<h3><?=GetMessage("CT_EL_LI_TITLE")?></h3>
            ...
            <div class="entry-c">
				...
				<div class="product-price">
					...
					<?else:?>
						...
						<?endif;?>
		                <div class="entry-content">
		                    <a href="<?=$arParams["LINK_TO_AJAX"]?>?TYPE=<?=$arParams["AJAX_TYPE"]?>&ELEMENT_CODE=<?=$arItem["CODE"]?>" data-lightbox="ajax"
							   class="button button-rounded button-mini noleftmargin" rel="nofollow">
