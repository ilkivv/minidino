...
if (IsModuleInstalled("sale") && IsModuleInstalled("boxsol.cosmofashion")) {
	$arComponentTemplates = array(
		"catalog.element" => "cosmos_sku",
		);
} else {
	$arComponentTemplates = array(
		"catalog.element" => "cosmos",
		);
}
...
<div class="single-product">
	<div class="product">
		<?$ElementID = $APPLICATION->IncludeComponent(
			...
			$arComponentTemplates["catalog.element"],
			array(
				"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
				"IBLOCK_ID" => $arParams["IBLOCK_ID"],
				...
				"AJAX_COSMOS_MODE" => $isAjax,
				"DETAIL_USE_TABS" => $arParams["DETAIL_USE_TABS"],
				"DETAIL_PAGE_TABS_SORT" => $arParams["DETAIL_PAGE_TABS_SORT"],
			),
			$component
		);?>
	</div>
...
<div class="col_full nobottommargin"><?
		...
		if ($ElementID > 0)
		{
			...
			{
				?><?$APPLICATION->IncludeComponent("bitrix:catalog.store.amount", "cosmos", array(
			...
			if (!empty($arRecomData))
			{
				if (ModuleManager::isModuleInstalled("sale") && (!isset($arParams['USE_BIG_DATA']) || $arParams['USE_BIG_DATA'] != 'N'))
				{
					...
					<div class="recommended__container" style="padding-top: 35px; ">
						<section id="content2">
						<div class="content-wrap notoppadding topmargin-sm">
						<div class="container nobottommargin">
						<h2 class="title--main">Дополните образ</h2>
						<div >
						
					<?$APPLICATION->IncludeComponent("bitrix:catalog.bigdata.products", "cosmos", array(
				...
				<section id="content2"><div class="content-wrap notoppadding topmargin-sm"><div class="container nobottommargin">
				<h2 class="title--main">Вам может понравиться</h2>
				<div>
				<?
				}
	...
	"AREA_FILE_SHOW" => "file",	// Показывать включаемую область
		"PATH" => $arParams["SIDEBAR_PATH"],	// Путь к файлу области
