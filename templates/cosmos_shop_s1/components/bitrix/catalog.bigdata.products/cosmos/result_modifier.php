...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		{
			$productPictures = CMarsShopHelper::getDoublePicturesForItem($arItem, $arParams['ADDITIONAL_PICT_PROP'][$itemIblockId], $resizeData);
		}
		else
		{
			$productPictures = CMarsShopHelper::getDoublePicturesForItem($arItem, false, $resizeData);
		}
		...
		if ($arItem['CATALOG'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS']))
		{
			...
			foreach ($arItem['OFFERS'] as $keyOffer => $arOffer)
			{
				...
				$offerPictures = CMarsShopHelper::getDoublePicturesForItem($arOffer, $arParams['ADDITIONAL_PICT_PROP'][$arOffer['IBLOCK_ID']], $resizeData);
