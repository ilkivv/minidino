...
$arTemplateParameters['LINK_TO_AJAX'] = array(
	'NAME' => GetMessage('CP_BCS_TPL_LINK_TO_AJAX'),
	'TYPE' => 'STRING',
	'DEFAULT' => SITE_DIR . "ajax/catalog.php",
);
$arAJAXType = array(
	'ZAKAZ' => GetMessage('CP_BCE_TPL_AJAX_TYPE_ZAKAZ'),
	'ZABRON' => GetMessage('CP_BCE_TPL_AJAX_TYPE_ZABRON'),
);
$arTemplateParameters['AJAX_TYPE'] = array(
	'NAME' => GetMessage('CP_BCS_TPL_AJAX_TYPE'),
	'TYPE' => 'LIST',
	"VALUES" => $arAJAXType,
	'DEFAULT' => "ZAKAZ",
);
...
$arTemplateParameters["SECTION_USE_IMAGE_RESIZE"] = array(
		"NAME" => GetMessage("MD_CAT_SEC_USE_IMAGE_RESIZE"),
		"TYPE" => "CHECKBOX",
		"MULTIPLE" => "N",
		"VALUE" => "Y",
		"DEFAULT" =>"N",
...
if ($arCurrentValues["SECTION_USE_IMAGE_RESIZE"] == "Y")
{
	$arTemplateParameters["SECTION_IMAGE_RESIZE_WIDTH"] = array(
		"PARENT" => "LIST_SETTINGS",
		"NAME" => GetMessage("MD_CAT_SEC_IMAGE_RESIZE_WIDTH"),
		"TYPE" => "STRING",
		"DEFAULT" => "360",
	);
	$arTemplateParameters["SECTION_IMAGE_RESIZE_HEIGHT"] = array(
		"PARENT" => "LIST_SETTINGS",
		"NAME" => GetMessage("MD_CAT_SEC_IMAGE_RESIZE_HEIGHT"),
		"TYPE" => "STRING",
		"DEFAULT" => "360",
	);
	$arItemSizes = array(
		BX_RESIZE_IMAGE_PROPORTIONAL => GetMessage("MD_CAT_SEC_IMAGE_RESIZE_TYPE_PROPORTIONAL"),
		BX_RESIZE_IMAGE_EXACT => GetMessage("MD_CAT_SEC_IMAGE_RESIZE_TYPE_EXACT"),
	);
	$arTemplateParameters["SECTION_IMAGE_RESIZE_TYPE"] = array(
		"PARENT" => "LIST_SETTINGS",
		"NAME" => GetMessage("MD_CAT_SEC_IMAGE_RESIZE_TYPE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "N",
		"ADDITIONAL_VALUES" => "N",
		"REFRESH" => "N",
