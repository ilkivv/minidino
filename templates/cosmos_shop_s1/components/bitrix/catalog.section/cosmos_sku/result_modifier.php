...
if (0 > $arParams['LINE_ELEMENT_COUNT'] || 5 < $arParams['LINE_ELEMENT_COUNT'])
	$arParams['LINE_ELEMENT_COUNT'] = 3;
...
if (!empty($arResult['ITEMS']))
{
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		if (!$arItem['PREVIEW_PICTURE']['SRC'])$arItem['PREVIEW_PICTURE'] = $arItem['DETAIL_PICTURE'];
		...
		if (!$arItem['PRODUCT_PREVIEW']['SRC'])$arItem['PRODUCT_PREVIEW'] = $arItem['DETAIL_PICTURE'];
		$arItem['PRODUCT_PREVIEW_SECOND'] = $productPictures['SECOND_PICT'];
		if (!$arItem['PRODUCT_PREVIEW_SECOND']['SRC'])$arItem['PRODUCT_PREVIEW_SECOND'] = $arItem['DETAIL_PICTURE'];
		if ($arResult['MODULES']['catalog'])
		{
			$arItem['CATALOG'] = true;
