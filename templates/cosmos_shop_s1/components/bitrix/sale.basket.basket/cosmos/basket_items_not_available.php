...
<div id="basket_items_not_available" class="table-responsive bottommargin">
				...
				<tr class="cart_item">
					...
					?>
						<td class="cart-product-add">
							<a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>" title="<?=GetMessage("SALE_ADD_TO_BASKET")?>"><i class="icon-shopping-cart"></i></a>
						</td>
						<?
						if ($bDeleteColumn):
						?>
							<td class="cart-product-remove">
								<a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>" title="<?=GetMessage("SALE_DELETE")?>"><i class="icon-trash2"></i></a>
							</td>
						<?
						endif;
						?>
