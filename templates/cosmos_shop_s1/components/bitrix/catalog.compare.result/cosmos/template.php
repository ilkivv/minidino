...
?>
	...
	<ul class="tab-nav tab-nav2 clearfix">
		<li class="<? echo (!$arResult["DIFFERENT"] ? 'ui-state-active' : ''); ?>"><a class="sortbutton" href="<? echo $arResult['COMPARE_URL_TEMPLATE'].'DIFFERENT=N'; ?>" rel="nofollow"><?=GetMessage("CATALOG_ALL_CHARACTERISTICS")?></a>
		</li>
		<li class="<? echo ($arResult["DIFFERENT"] ? 'ui-state-active' : ''); ?>"><a class="sortbutton" href="<? echo $arResult['COMPARE_URL_TEMPLATE'].'DIFFERENT=Y'; ?>" rel="nofollow"><?=GetMessage("CATALOG_ONLY_DIFFERENT")?></a></li>
	</ul>
		...
		<?
				switch($code)
				{
					case "NAME":
						...
						<noindex><br /><a class="button button-mini noleftmargin" href="<?=$arElement["BUY_URL"]?>" rel="nofollow"><?=GetMessage("CATALOG_COMPARE_BUY"); ?></a></noindex>
