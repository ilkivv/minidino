...
<div class="bx_ordercart">
					...
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arColumn):
						...
						?>
							<td class="cart-product-price">
								...
								<?
								$divDiscountStyle = '';
								if ($arItem["DISCOUNT_PRICE_PERCENT_FORMATED"] == "0%" || $arItem["DISCOUNT_PRICE_PERCENT_FORMATED"] == NULL) {
								...
								<div id="discount_info_<?=$arItem["ID"]?>"<?=$divDiscountStyle?>>
									...
									<span class="label label-success">Ёкономи€: <span id="discount_value_num_<?=$arItem["ID"]?>"><?=CCurrencyLang::CurrencyFormat($arItem["DISCOUNT_PRICE"], $arItem["CURRENCY"], true);?></span></span>
								</div>
							</td>
						<?
	...
	<div class="">
		...
		<div class="col_full">
			...
			<textarea class="sm-form-control" name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" style="max-width:100%;min-height:120px"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
