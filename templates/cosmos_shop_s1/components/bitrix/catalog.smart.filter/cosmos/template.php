...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<div class="row sidebar-row">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					//if($arItem["CODE"] == "COLOR_REF") continue;
					?>
					<div class="sidebar-list__wrapper <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="bx-filter-parameters-box-hint"><?=$arItem["NAME"]?>
								<?if ($arItem["FILTER_HINT"] <> ""):?>
									<i id="item_title_hint_<?echo $arItem["ID"]?>" class="icon icon-question-circle"></i>
								...
								<?endif?>
								<i data-role="prop_angle" class="icon icon-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?> fright"></i>
							</span>
						</div>

						<div class="bx-filter-block" data-role="bx_filter_block">
							<div class="bx-filter-parameters-box-container sidebar-list__flex-container">
							<?
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
										...
										<script type="text/javascript">
											$(document).ready(function () {
												$(".range_03").ionRangeSlider({
													...
													grid: true,
													from: <?echo ($arItem["VALUES"]["MIN"]["HTML_VALUE"]) ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : "null"?>,
													to: <?echo ($arItem["VALUES"]["MAX"]["HTML_VALUE"]) ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : "null"?>,
												    onChange: function (data) {
												    	$("#<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>").val(data.from);
												    	$("#<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>").val(data.to);

												    	$("#<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>").keyup();
												    	$("#<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>").keyup();
												    },
												});
											});
										</script>
								...
								default://CHECKBOXES
									?>
									<?foreach($arItem["VALUES"] as $val => $ar):?>
										<div class="sidebar-list__flex-item">
											<input
												type="checkbox"
											...
											/>
											<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <? echo $ar["DISABLED"] ? 'disabled': '' ?> checkbox-style-3-label checkbox-small" for="<? echo $ar["CONTROL_ID"] ?>">
												<?=$ar["VALUE"];?><?
													if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
														?> <span>(</span><span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span><span>)</span><?
													endif;?>
											</label>
										</div>
									<?endforeach;?>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active sidebar-price__wrapper">
							<span class="bx-filter-container-modef"></span>
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
								<span>
									<?/*=$arItem["NAME"]*/?>
							...
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row sidebar-row bx-filter-parameters-box-container sidebar-price">
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-left sidebar-price__min">
										<i class="bx-ft-sub sidebar-price__span"><?=GetMessage("CT_BCSF_FILTER_FROM")?></i>
										<div class="bx-filter-input-container sidebar-price__imput-wrapper">
											<input
												class="min-price sm-form-control sidebar-price__input sidebar-price__input--min"
												type="text"
												name="<?echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>"
												id="<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>"
												value="<?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"]?>"
									...
									<div class="col-xs-6 bx-filter-parameters-box-container-block bx-right sidebar-price__max">
										<i class="bx-ft-sub sidebar-price__span"><?=GetMessage("CT_BCSF_FILTER_TO")?></i>
										<div class="bx-filter-input-container sidebar-price__imput-wrapper">
											<input
												class="max-price sm-form-control sidebar-price__input sidebar-price__input--max"
												type="text"
												name="<?echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>"
												id="<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"
												value="<?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"]?>"
									...
									<div class="col_full sidebar-price__range">
										<input class="range_03" />
										<script type="text/javascript">
											$(document).ready(function () {
												$(".range_03").ionRangeSlider({
			...
			<div class="row sidebar-row">
				<div class="col-xs-12 bx-filter-button-box sidebar-buttons__wrapper">
